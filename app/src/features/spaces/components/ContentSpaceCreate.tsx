...
import { Input, Checkboxes, Button, IconButton, Icon, UnSelectItem, DeletableSelectItem, InputField } from "@/components/Elements"
...
export const ContentSpaceCreate = (): JSX.Element => {
  ...
  return (
    <ContentWithSubContentLayout subContentKey={subContentKey} setSubContentKey={setSubContentKey}>
      <div key="content" className="p-8">
        <h1 className="text-h400 tex-natural-900 mb-8">スペース作成</h1>
